  ...
  mounted() {
    ...
    wx.ready(function() {
      wx.onMenuShareTimeline({
        title: "定制宝贝环球足迹", // 分享标题
        link: "https://www.mufenggame.com/?CKTAG=ef.share.momet", // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
      ...
      wx.onMenuShareAppMessage({
        ...
        link: "https://www.mufenggame.com/?CKTAG=ef.share.msg", // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
        imgUrl: "https://www.mufenggame.com/loading/loading.png", // 分享图标
